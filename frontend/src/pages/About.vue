...
onMounted(() => {
  setMeta({
    title: 'เกี่ยวกับเรา (About Us) - ' + (settingsStore.storeName || 'KODERA Wire Processing Machines'),
    description: 'ทำความรู้จัก บริษัท แคส-ซีอาร์ จำกัด (CR Distribution) ผู้นำเข้าและตัวแทนจำหน่ายเครื่องตัดปอกสายไฟอัตโนมัติ KODERA และโซลูชัน Wire Harness ครบวงจร ด้วยประสบการณ์กว่า 20 ปี',
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div class="bg-white dark:bg-[#10141D] rounded-3xl p-8 sm:p-10 border border-slate-200/80 dark:border-white/[0.06] shadow-xl shadow-slate-900/5 dark:shadow-black/20 relative overflow-hidden">
            ...
            <p class="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed font-light">
              {{ s.about_vision_desc || 'มุ่งมั่นสู่การเป็นผู้นำอันดับหนึ่งในการนำเข้า จัดจำหน่าย และให้บริการเครื่องจักรตัดปอกสายไฟอัตโนมัติและโซลูชัน Wire Harness คุณภาพมาตรฐานญี่ปุ่น ที่ได้รับความไว้วางใจสูงสุดจากโรงงานอุตสาหกรรมทั่วประเทศไทย' }}
            </p>
          </div>
