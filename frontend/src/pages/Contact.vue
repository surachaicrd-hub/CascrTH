...
const subjectOptions = [
  'สอบถามข้อมูลเครื่องจักร KODERA',
  'ขอใบเสนอราคา / สั่งซื้อเครื่องจักร',
  'นัดหมายทดสอบตัดปอกชิ้นงานสายไฟ (Sample Test)',
  'บริการหลังการขาย / แจ้งซ่อม / สั่งซื้ออะไหล่',
  'เรื่องอื่นๆ'
]
...
const addStructuredData = () => {
  ...
  setMeta({
    ...
    description: 'ช่องทางการติดต่อ สอบถามข้อมูลเครื่องตัดปอกสายไฟอัตโนมัติ KODERA นัดหมายสาธิตเครื่อง เบอร์โทรศัพท์ LINE อีเมล และที่อยู่ศูนย์บริการ',
