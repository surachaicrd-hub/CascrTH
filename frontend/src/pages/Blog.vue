        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div class="text-center md:text-left">
            ...
            <p class="mt-3 text-slate-400 text-sm md:text-base max-w-2xl leading-relaxed">
              เจาะลึกเทคนิคการจัดพื้นที่ เคล็ดลับดูแลรักษา และแรงบันดาลใจในการตกแต่งบ้านเก็บของและโรงเรือน
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div class="lg:col-span-7 relative rounded-2xl overflow-hidden aspect-[16/10] lg:aspect-[1.8/1] bg-slate-950 shadow-inner">
              ...
              <div class="absolute top-4 left-4 flex gap-2">
                <span class="bg-gradient-to-r from-amber-400 to-orange-500 text-white px-3 py-1 text-[10px] font-black rounded-full uppercase tracking-wider shadow-md flex items-center gap-1">
