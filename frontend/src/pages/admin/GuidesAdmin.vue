...
const generateWithAI = async (type) => {
    ...
    if (type === 'installation') {
        promptTitle = 'คู่มือการติดตั้งและเตรียมความพร้อมเครื่องจักร (Machine Setup & Installation Guide)'
        prompt = `เขียน "คู่มือการเตรียมความพร้อมและติดตั้งเครื่องจักร KODERA (Machine Setup & Installation Guide)" สำหรับ บริษัท ซีอาร์ ดิสทริบิวชั่น จำกัด เป็นภาษาไทยมืออาชีพ
        ที่มีความเป็นทางการ น่าเชื่อถือ และอ่านง่าย มีรายละเอียดเช่น 
        1. การเตรียมพื้นที่และโต๊ะปฏิบัติงาน (ระดับความสูง แสงสว่าง และการระบายอากาศ)
        2. การเตรียมระบบไฟฟ้าและลม (แรงดันไฟ AC 220V และแรงดันลม Air Supply ตามสเปกเครื่อง)
        3. ขั้นตอนการส่งมอบ การติดตั้ง และการ Set-up ใบมีด
        4. การทดสอบการตัดปอกสายไฟตัวอย่างและการฝึกอบรมผู้ปฏิบัติงาน
        ...
        prompt = `เขียน "ข้อตกลงและเงื่อนไขการสั่งซื้อและชำระเงิน (Ordering and Payment Methods)" สำหรับบริษัทของเรา เป็นภาษาไทยมืออาชีพ
        โดยมีหัวข้อดังนี้
