...
const generateWithAI = async (type) => {
  ...
  if (type === 'privacy') {
    ...
    promptText = 'เขียนนโยบายความเป็นส่วนตัว (Privacy Policy) สำหรับเว็บไซต์ขายและรับสร้างโกดัง บ้านเก็บของที่เก็บข้อมูลชื่อ เบอร์โทร อีเมล เพื่อติดต่อกลับ โดยจัดหน้าเป็น HTML ให้อ่านง่าย เน้นความน่าเชื่อถือ'
  } else if (type === 'terms') {
    contentRef = termsOfServiceContent
    typeLabel = 'เงื่อนไขการให้บริการ'
    promptText = 'เขียนเงื่อนไขการให้บริการ (Terms of Service) สำหรับเว็บไซต์ขายและรับสร้างโกดัง บ้านเก็บของ โดยจัดหน้าเป็น HTML ให้อ่านง่าย เน้นความน่าเชื่อถือและการรับประกันโครงสร้าง'
  } else if (type === 'cookie') {
    contentRef = cookiePolicyContent
    typeLabel = 'นโยบายคุกกี้'
    promptText = 'เขียนนโยบายการใช้คุกกี้ (Cookie Policy) แนะนำประเภทคุกกี้(จำเป็น, สถิติ, โฆษณา)และการจัดการคุกกี้ เพื่อปฏิบัติตาม PDPA สำหรับเว็บไซต์ขายและรับสร้างโกดัง โดยจัดหน้าเป็น HTML ให้อ่านง่าย'
  } else if (type === 'warranty') {
    contentRef = warrantyPolicyContent
    typeLabel = 'นโยบายการรับประกัน'
    promptText = 'เขียนนโยบายและเงื่อนไขการรับประกันโครงการ โครงสร้างโกดัง และบ้านเก็บของ (Warranty Policy) ระบุระยะเวลารับประกัน 10 ปีสำหรับโครงสร้างและข้อยกเว้นต่างๆ โดยจัดหน้าเป็น HTML ให้อ่านง่าย น่าเชื่อถือ'
  }
