...
const generateWithAI = async (type) => {
  ...
  if (type === 'privacy') {
    ...
    promptText = 'เขียนนโยบายความเป็นส่วนตัว (Privacy Policy) ตามมาตรฐาน PDPA สำหรับ บริษัท ซีอาร์ ดิสทริบิวชั่น จำกัด ผู้นำเข้าและจำหน่ายเครื่องตัดปอกสายไฟ KODERA โดยอ้างอิงข้อมูลติดต่อและข้อมูลบริษัทจริง'
  } else if (type === 'terms') {
    contentRef = termsOfServiceContent
    typeLabel = 'เงื่อนไขการให้บริการ'
    promptText = 'เขียนเงื่อนไขและข้อตกลงการให้บริการ (Terms of Service) สำหรับการจัดจำหน่ายเครื่องตัดปอกสายไฟ KODERA, การส่งมอบติดตั้งหน้างาน และการฝึกอบรม โดย บริษัท ซีอาร์ ดิสทริบิวชั่น จำกัด'
  } else if (type === 'cookie') {
    contentRef = cookiePolicyContent
    typeLabel = 'นโยบายคุกกี้'
    promptText = 'เขียนนโยบายการใช้คุกกี้ (Cookie Policy) อธิบายประเภทคุกกี้และการจัดการคุกกี้สำหรับเว็บไซต์เครื่องตัดปอกสายไฟ KODERA ของ บริษัท ซีอาร์ ดิสทริบิวชั่น จำกัด'
  } else if (type === 'warranty') {
    contentRef = warrantyPolicyContent
    typeLabel = 'นโยบายการรับประกัน'
    promptText = 'เขียนนโยบายและเงื่อนไขการรับประกันเครื่องจักร KODERA (Machine Warranty Policy) 1 ปีเต็ม พร้อมบริการ On-site Service และเงื่อนไขอะไหล่แท้สำหรับ บริษัท ซีอาร์ ดิสทริบิวชั่น จำกัด'
  }
              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h3 class="text-base font-bold text-gray-900">
                    ผู้ช่วย AI ร่าง
                    <span v-if="activeTab === 'privacy'">นโยบายความเป็นส่วนตัว (PDPA)</span>
                  ...
                  <p class="text-sm text-gray-500 mt-0.5">
                    <span v-if="activeTab === 'privacy'">ร่างนโยบายครอบคลุมมาตรฐาน PDPA และข้อมูลติดต่อจริงของบริษัท ซีอาร์ ดิสทริบิวชั่น จำกัด</span>
                    <span v-else-if="activeTab === 'terms'">ร่างเงื่อนไขการจำหน่ายเครื่องตัดปอกสายไฟ KODERA, การส่งมอบ, ติดตั้ง และการฝึกอบรม</span>
                    <span v-else-if="activeTab === 'cookie'">สร้างคำอธิบายการจัดเก็บคุกกี้ ประเภทคุกกี้ และวิธีการจัดการตามมาตรฐานสากล</span>
                    <span v-else-if="activeTab === 'warranty'">ร่างเงื่อนไขการรับประกันเครื่องจักร KODERA 1 ปี, บริการ On-site Service, และข้อตกลงอะไหล่แท้</span>
                  </p>
                </div>
              </div>
