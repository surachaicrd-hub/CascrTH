              ...
              <div v-if="previewSubTab === 'google'" class="p-6 bg-slate-50 border border-gray-200 rounded-2xl space-y-3">
                ...
                <div v-if="previewData.data.googleSnippet.priceFormatted" class="flex items-center gap-3 text-xs pt-1">
                  ...
                  <span class="text-amber-600 font-bold flex items-center gap-1">
                    ...
                    {{ previewData.data.googleSnippet.rating }} ({{ previewData.data.googleSnippet.reviewCount }} รีวิว)
                  </span>
                  <span class="text-emerald-600 font-bold flex items-center gap-1" v-if="previewData.data.googleSnippet.inStock">
