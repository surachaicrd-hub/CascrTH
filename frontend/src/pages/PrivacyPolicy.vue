...
const loadContent = async () => {
    ...
    try {
        ...
        if (data.success && data.data) {
            ...
            content.value = '<div class="text-center py-20 text-gray-500">ยังไม่มีข้อมูลนโยบายความเป็นส่วนตัว</div>'
        }
    } catch (error) {
    ...
    <div class="relative bg-gray-50 dark:bg-[#0a0f16] min-h-[80vh] py-24 sm:py-32 overflow-hidden transition-colors duration-500 pt-32 lg:pt-40">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10">
            ...
            <div class="text-center mb-16">
                ...
                <h1 class="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-6 tracking-tight">นโยบายความเป็นส่วนตัว</h1>
                <p class="text-lg text-emerald-600 dark:text-emerald-400 font-medium tracking-widest uppercase">Privacy Policy</p>
