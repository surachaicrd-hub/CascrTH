...
router.get('/public', async (req, res) => {
    try {
        ...
        const publicKeys = [
            ...
            'projects_hero_badge', 'projects_hero_title', 'projects_hero_subtitle', 'projects_hero_desc',
            'projects_stat_1_val', 'projects_stat_1_label',
            'projects_stat_2_val', 'projects_stat_2_label',
            'projects_stat_3_val', 'projects_stat_3_label',
