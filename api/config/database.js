...
const pool = mysql.createPool({
  ...
  database: process.env.DB_NAME || 'storageshed_db',
...
async function initDB() {
  try {
    ...
    const defaultContactSettings = [
      ...
      ['contact_email', 'panuwat@morespace.co.th'],
      ['contact_email2', 'sale1@morespace.co.th'],
      ['contact_line_id', '@morespace'],
      ['contact_line_url', 'https://line.me/R/ti/p/@morespace'],
